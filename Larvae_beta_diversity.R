...
ordi_plot=plot_ordination(phy.t,ord, color = "stage2") +
...
#all comparisons
all_pairWadonis_df=pairwise.adonis(otu.n[,1:1490], otu.n$Stage,  sim.method = "euclidean", p.adjust.m = "BH", perm = 9999) 
